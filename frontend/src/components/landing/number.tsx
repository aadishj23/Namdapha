const Numbers = () => {
  return (
    <div className="relative px-auto p-6 md:p-8 flex flex-col gap-5 py-16 md:py-24 mt-20 md:mt-40">
      ...
      {/* Image & Text Section */}
      <div className="mt-10 md:mt-20 flex flex-col md:flex-row items-center mb-8">
        <div className="w-full md:w-1/2 pr-0 md:pr-4">
          <img src="./test.svg" height={100} alt="Namdapha Tiger Reserve" className="rounded-lg w-full" />
        </div>
        <div className="md:w-1/2 pl-0 md:pl-4 mt-4 md:mt-0 mx-5">
